    ...
    if (distance < 0) {
        ...
        document.getElementById("demo").innerHTML = "EXPIRED";
                  ...
                  elseif ($CheckingMarching->payment_status == "waiting") {
                    echo '  <div class="card-body text-center" style="background-color: #dc3545; color: #fff;"><h3>Your payment proof has been submit and waiting for confirmation, please wait or call the receiver for activation</h3></div>';
                  }

                   elseif ($CheckingMarching->payment_status == "confirm") {
                    echo '  <div class="card-body text-center" style="background-color: #218838; color: #fff;"><h3>This payment has been confirmed by the receiver, Happy Earning</h3></div>';
                  }else{
