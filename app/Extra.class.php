...
{
	echo '<div class="alert alert-solid bg-success" style="background-color: #4caf50;color: #fff;font-size: 16px;font-weight: 600;border-color: #4caf50;"><center><strong style="font-size:24px !important;">You have no court cases</strong></center><br> Court cases only appear here when you have a payment dispute with another member. Payment Disputes range from "Receiver not confirming payment before the given time elapses" to "Payer presenting payment evidence that has been marked as dubious by the Receiver". When you have disputes of such, your court cases will appear here.</div>';
}
}
