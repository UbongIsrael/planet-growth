...
function confirmPay($payment_method,$bankname,$accountnumber,$accountname,$depositor ,$paymentlocal,$paymentpof, $user_id, $id)
{
    ...
    $user = DB::table('users')->where('id', $user_id)->first();
     $subject = 'You have submit your payment information' .Config::get('app.name');
      ...
      $message = "<h3>You have successfully submit your payment information</h1><br><br>
                      <p> You have successfully submit your payment information, please call the receiver for confirmation.</p>";
      include 'emails.php';
  ...
  You have successfully submit your payment information, please call the receiver for confirmation.
</div>';
        }
else{
...
function confirmUserPay($user_id, $sender_userid, $id){
 ...
 $sql = DB::table('marching')
  ...
  You have successfully confirm the payment.
    ...
    array('userid' =>        $user_id,
         'type' =>        "confirm",
          'details' =>    "You have successfully confirm the payment", 
          'status'  =>    "verify",
          'faIcon'     =>    "fa fa-usd")
);
        }
...
function ReportUserMargin($user_id, $sender_userid, $id,$enquiry,$des){
    ...
    array('userid' =>        $user_id,
         'type' =>        "confirm",
          'details' =>    "You have successfully report the payment you received and will be resolved soon", 
          'status'  =>    "verify",
          'faIcon'     =>    "fa fa-gavel")
);
