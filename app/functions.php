...
function GetMargin($user_id)
{
  $settings = DB::table('settings')->where('id', 1)->first();
    ...
    elseif ($row->payment_status == "waiting") {
    	echo '  <div class="card-body text-center" style="background-color: #dc3545; color: #fff;">Your payment is waiting for Approval<br>Please wait or call the receiver on '.$user_receiver->phonenumber.' for confirmation</div>';
    }
